...
download_motd_script() {
    ...
    if [ "$os_type" == "debian" ]; then
        ...
        # 下载两个文件
        file_url_1="https://ghp.ci/https://raw.githubusercontent.com/qljsyph/bash-script/refs/heads/main/sysinfo/20-debian-sysinfo"
        file_url_2="https://ghp.ci/https://raw.githubusercontent.com/qljsyph/bash-script/refs/heads/main/sysinfo/00-debian-heads"
        ...
        file_url="https://ghp.ci/https://raw.githubusercontent.com/qljsyph/bash-script/refs/heads/main/sysinfo/20-armbian-sysinfo2"
